...
7. Availability-only model: index hour and 39 post-range-filter availability indicators are used. The analysis tests whether measurement presence carries predictive information; it is not a complete measurement-process model because it omits recency and frequency.
